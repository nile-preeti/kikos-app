...
const BookTaxiScreen = props => {
  ...
  return (
    <SafeAreaView style={{backgroundColor: COLORS.White, height: '100%',}}>
      ...
      <View style={{justifyContent: 'center', alignItems:'center',width:dimensions.SCREEN_WIDTH *1,}}>
        ...
        <View style={{}}>
          ...
          <View style={styles.btncontainer}>
            ...
            <TouchableOpacity style={styles.btn} onPress={()=>{props.navigation.navigate('BookTaxi')}}>
            <View
            style={{
              width: 50,
              // alignSelf: 'center',
          ...
          <View style={{justifyContent: 'center', alignItems: 'center',marginTop:10,marginBottom:300, }}>
            <FlatList
                    ...
                    <View style={styles.cardConainer}>
                      <View style={styles.btnContainer1}>
                        <View style={styles.imgContainer}>
                          <Image style={styles.img} source={item?.user_profile != "" ? {uri:`${item?.user_profile}`} : require('../../assets/images/largeimages/dummy_profile.png')} />
                        </View>
                        <Text numberOfLines={1} style={styles.titleTxt}>{item?.user_name}</Text>
                      ...
                      <View style={styles.bookingIdContainer}>
                        ...
                        <Text style={styles.bookingIdN}>{item?.booking_id}</Text>
